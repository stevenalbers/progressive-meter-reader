...
int main()
{
	...
	*/
	...
	{
		if(s==2) str2.append("."); // 3rd char from right - decimal point
		else if( (s-5)%3==0 && str.at(s-1)!='$' ) str2.append(","); // 3rd char from right - decimal point

		char c = str.at(str.length()-1-s); // move right to left and copy
		string str1 =  ; // convert char to string
		str2.append(str1); // copy the char to the right-to-left string
		cout << str1 << endl;
	}*/
	...
	{
		cout << str2.at(s); // copy the char to the right-to-left string
	}*/
