...
bool detectNextAndMatch(Mat , Mat , float [][charsToClassify]);
...
int main()
{
	...
	if(gameChoice == 1)
	{
		train("../src/trainCashburstJ1/0.jpg", contour, hierarchy, fDatabase, '0');
		train("../src/trainCashburstJ1/1.jpg", contour, hierarchy, fDatabase, '1');
		train("../src/trainCashburstJ1/2.jpg", contour, hierarchy, fDatabase, '2');
		train("../src/trainCashburstJ1/3.jpg", contour, hierarchy, fDatabase, '3');
		train("../src/trainCashburstJ1/4.jpg", contour, hierarchy, fDatabase, '4');
		train("../src/trainCashburstJ1/5.jpg", contour, hierarchy, fDatabase, '5');
		train("../src/trainCashburstJ1/6.jpg", contour, hierarchy, fDatabase, '6');
		train("../src/trainCashburstJ1/7.jpg", contour, hierarchy, fDatabase, '7');
		train("../src/trainCashburstJ1/8.jpg", contour, hierarchy, fDatabase, '8');
		train("../src/trainCashburstJ1/9.jpg", contour, hierarchy, fDatabase, '9');
		train("../src/trainCashburstJ1/dollar.jpg", contour, hierarchy, fDatabase, '$');
	}
...
bool detectNextAndMatch(Mat imgDtct, Mat imgWithContours, float fDatabase[][charsToClassify])
{
...
{
	// create a blank image of the same size as the testing image:
