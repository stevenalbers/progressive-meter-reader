...
void detectNextAndMatch(ofstream & toFile, Mat , Mat , float [][charsToClassify]);
	...
	for ( currJVal=0; currJVal < numJVals; currJVal++)
	{
		...
		if(gameChoice == 1) // if cashburst, ... .
		{
			...
			if( currJVal == 0 ) // for j0 (assuming j0 is unique)
			{
				...
				for(int i=0; i < charsToClassify; i++)
				{
					...
					string pathStr = "";
					pathStr.append("../src/trainCashburstJ0/");
					...
					{
						pathStr.append("dollar");
						charASCII = '$';
					}

					pathStr.append(".jpg");
					train(toFile, pathStr, fDatabase, charASCII);
				}
			}
			...
			{
				toFile << endl << endl << endl;
				train(toFile, "../src/trainCashburstJ14/0.jpg", fDatabase, '0');
				train(toFile, "../src/trainCashburstJ14/1.jpg", fDatabase, '1');
				train(toFile, "../src/trainCashburstJ14/2.jpg", fDatabase, '2');
				train(toFile, "../src/trainCashburstJ14/3.jpg", fDatabase, '3');
				train(toFile, "../src/trainCashburstJ14/4.jpg", fDatabase, '4');
				train(toFile, "../src/trainCashburstJ14/5.jpg", fDatabase, '5');
				train(toFile, "../src/trainCashburstJ14/6.jpg", fDatabase, '6');
				train(toFile, "../src/trainCashburstJ14/7.jpg", fDatabase, '7');
				train(toFile, "../src/trainCashburstJ14/8.jpg", fDatabase, '8');
				train(toFile, "../src/trainCashburstJ14/9.jpg", fDatabase, '9');
				train(toFile, "../src/trainCashburstJ14/dollar.jpg", fDatabase, '$');
			}	
		}
		...
		if(gameChoice == 2) // if InstantRiches, ... .
		{
			...
			if( currJVal == 0 ) // for j0 (assuming j0 is unique)
			{
				numOfDilErdSteps = 2;
				toFile << endl << endl << endl;
				train(toFile, "../src/trainInstRichJ0/0.jpg", fDatabase, '0');
				train(toFile, "../src/trainInstRichJ0/1.jpg", fDatabase, '1');
				train(toFile, "../src/trainInstRichJ0/2.jpg", fDatabase, '2');
				train(toFile, "../src/trainInstRichJ0/3.jpg", fDatabase, '3');
				train(toFile, "../src/trainInstRichJ0/4.jpg", fDatabase, '4');
				train(toFile, "../src/trainInstRichJ0/5.jpg", fDatabase, '5');
				train(toFile, "../src/trainInstRichJ0/6.jpg", fDatabase, '6');
				train(toFile, "../src/trainInstRichJ0/7.jpg", fDatabase, '7');
				train(toFile, "../src/trainInstRichJ0/8.jpg", fDatabase, '8');
				train(toFile, "../src/trainInstRichJ0/9.jpg", fDatabase, '9');
				train(toFile, "../src/trainInstRichJ0/dollar.jpg", fDatabase, '$');
			}
			...
			if( currJVal == 1 ) 
			{
				numOfDilErdSteps = 1;
				toFile << endl << endl << endl;
				train(toFile, "../src/trainInstRichJ14/0.jpg", fDatabase, '0');
				train(toFile, "../src/trainInstRichJ14/1.jpg", fDatabase, '1');
				train(toFile, "../src/trainInstRichJ14/2.jpg", fDatabase, '2');
				train(toFile, "../src/trainInstRichJ14/3.jpg", fDatabase, '3');
				train(toFile, "../src/trainInstRichJ14/4.jpg", fDatabase, '4');
				train(toFile, "../src/trainInstRichJ14/5.jpg", fDatabase, '5');
				train(toFile, "../src/trainInstRichJ14/6.jpg", fDatabase, '6');
				train(toFile, "../src/trainInstRichJ14/7.jpg", fDatabase, '7');
				train(toFile, "../src/trainInstRichJ14/8.jpg", fDatabase, '8');
				train(toFile, "../src/trainInstRichJ14/9.jpg", fDatabase, '9');
				train(toFile, "../src/trainInstRichJ14/dollar.jpg", fDatabase, '$');
			}	
		}
		...
		{
			detectNextAndMatch(toFile, imageGray, imgWithContours, fDatabase);
...
void train(ofstream & toFile, std::string imageFile, float fDatabase [][charsToClassify],
		char whichChar)
{
	toFile << "Classifying " << whichChar << "\n";
	...
	toFile << "Num of points: " << numPoints << endl; 
	clearFlags(imgPxlsFlags, image); // clear after allocation
	...
	if (whichChar == '9')
	{
		...
		{
			toFile << pow( pow(abs(arrayPoints[i].x - ctrd.x),2.0) + pow(abs(arrayPoints[i].y - ctrd.y),2.0) , 0.5) << endl;
		}
	}
	*/
	// ------------------------------------------------------------------------
...
void detectNextAndMatch(ofstream & toFile, Mat imgDtct, Mat imgWithContours, float fDatabase[][charsToClassify])
{
	...
	for(int i=0; i < charsToClassify; i++)
	{
		...
		if( i <= charsToClassify-2 ) // 11-2=9 => 0-9
			toFile << "Eucl. dist. from " << i;
		else toFile << "Eucl. dist. from $";
		toFile << ": " << euclDist << endl;
	...
	*/
	...
	toFile << "  =  Min. eucl. dist.: " << minEuclDist << endl << endl;
	//toFile << "2nd Min. eucl. dist.: " << minEuclDist2 << endl;
	//toFile << "Confusion differential (if correct: low - OK, high - very good): " << minEuclDist2-minEuclDist << endl << endl;
...
void formatCurrJVal(ofstream & toFile)
{
	//cout << "Formatting the current jackpot value" << endl << endl;
